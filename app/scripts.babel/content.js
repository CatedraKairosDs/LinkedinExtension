    ...
    function(request, sender, sendResponse) {
        ...
        if (document.getElementById('profile-education')) {
            ...
            for (var i = 0; i < educationAll.length; i++) {
                ...
                var uni = education.childNodes[0].childNodes[0].innerHTML;
        ...
        if (document.getElementById('profile-certifications')) {
            ...
            for (var i = 0; i < certificates.length; i++) {
                ...
                var certName = certificado.childNodes[0].childNodes[0].innerHTML;
        ...
        if (document.getElementById('profile-honors')) {
            ...
            for (var i = 0; i < awards.length; i++) {
                ...
                var organisation = award.childNodes[0].childNodes[1].innerHTML;
        ...
        if (document.getElementById('profile-orgs')) {
            ...
            for (var i = 0; i < organizaciones.length; i++) {
                ...
                var orgName = organizacion.childNodes[0].childNodes[0].innerHTML;
        ...
        if (document.getElementById('profile-volunteer')) {
            ...
            for (var i = 0; i < volunteerExperiences.length; i++) {
                ...
                var nameExp = volunteerExperience.childNodes[0].childNodes[0].innerHTML;
        ...
        if (document.getElementById('profile-recommendations')) {
            ...
            for (var i = 0; i < recommendations.length; i++) {
                ...
                var whoRec = recommendation.childNodes[1].childNodes[0].childNodes[1].childNodes[0].childNodes[0].innerHTML;
                var posWhoRec = recommendation.childNodes[1].childNodes[0].childNodes[1].childNodes[1].innerHTML;
